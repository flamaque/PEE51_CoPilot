...
const int bufferSize = 7168; //6144; //8192 Waarschijnlijk te groot
...
void setup()
{
  ...
  vTaskDelay(2000 / portTICK_PERIOD_MS);                            // Give some time for the serial communication to establish
