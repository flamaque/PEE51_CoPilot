...
float ESP_PH::readPH(float voltage, float temperature)
{
...
void ESP_PH::calibration(float voltage, float temperature, char *cmd)
{
...
void ESP_PH::calibration(float voltage, float temperature)
{
    this->_voltage = voltage;
    this->_temperature = temperature;
...
boolean ESP_PH::cmdSerialDataAvailable()
{
...
byte ESP_PH::cmdParse(const char *cmd)
{
    byte modeIndex = 0;
...
void ESP_PH::phCalibration(byte mode)
{
